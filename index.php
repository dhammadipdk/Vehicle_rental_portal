      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <p>We have all cars in good condition, choose the best one.</p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>There are many variation to Automobiles. Technology and Human productiveness made it possible to roam source to destination travelling in different features in-built in these Automobiles. Look here for those Features which you find most astonishing to travel with! Hurray!</p>
    </div>
    <div class="row"> 
